...
foreach ($row in $excelData) {
    ...
    $folderPath = "C:\Project for Beni\Tests\test 8\folders\$($row.ID)"
    ...
    Write-Progress -Activity "Creating summery files files" -Status "Creating summery files dor $($row.ID)" -PercentComplete (($currentItem / $totalItems) * 100)
